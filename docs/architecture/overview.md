...
- Per-tier 16-factor assessments and a C1/C2/C3 architecture rollup are generated by the
  `rabbit-architecture-assessment-tier`/`-rollup` skills into
  [`meta/architecture-assessment/README.md`](../../meta/architecture-assessment/README.md).
