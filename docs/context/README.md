...
- [`routing-map.md`](routing-map.md): command/skill route IDs, exact-file baselines, and triggers for broader context discovery
...
- progressive routing rules and selection evidence
...
Bootstrap may refresh evidence-backed route rows. Promotion, ingestion, and PR-gap workflows propose
a route-row update whenever a new durable document should become baseline context.
