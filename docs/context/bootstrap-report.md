...
- Mode: `guided` or `automated`
- Resulting status: `draft` or `verified`
- Final guided confirmation received: `yes`, `no`, or `not applicable`
...
- Application code changed: must be `no`
