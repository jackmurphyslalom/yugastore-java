...
Use this command after `__SPECKIT_COMMAND_SPECIFY__` to turn UI-relevant stories in a Spec Kit feature spec into static, reviewable concept mockups and handoff notes.
